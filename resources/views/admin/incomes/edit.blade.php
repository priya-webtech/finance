                                        ...
                                        <div class="col-sm-4 comment">
                                            <div class="form-group">
                                                ...
                                                <textarea id="value" step=".01" name="income[{{$keys}}][comments]"
                                                       class="form-control" type="text" value="{{$studDetail->studFeesColl->getIncome->comment}}">{{$studDetail->studFeesColl->getIncome->comment}}</textarea>
                                                <span class="error-is_required" style="color:red"></span>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                    ...
                                    @foreach($corporate->corporateDetail as $keys=>$corpoDetail)
                                        ...
                                        <div class="col-sm-4 comment">
                                            <div class="form-group">
                                                <label>Comment</label><br>
                                                <textarea id="value" step=".01" name="income[{{$keys}}][comments]"
                                                       class="form-control" type="text" value="{{$corpoDetail->corpoFeesColl->getIncome->comment}}">{{$corpoDetail->corpoFeesColl->getIncome->comment}}</textarea>
                                                <span class="error-is_required" style="color:red"></span>
                                            </div>
                                        </div>
                                         <div class="col-sm-4">
