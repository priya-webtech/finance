...
<div class="form-group col-sm-6">
    {!! Form::label('enquiry_type_id', 'Enquiry Type') !!}<span style="color:red;">*</span> :
...
<div class="form-group col-sm-6">
    {!! Form::label('lead_source_id', 'Lead Source') !!}<span style="color:red;">*</span> :
...
<!-- Web Site Field -->
<div class="form-group col-sm-6">
    {!! Form::label('web_site', 'Web Site') !!}<span style="color:red;">*</span> :
...
<!-- Reg For Month Field -->
<div class="form-group col-sm-6">
    {!! Form::label('reg_for_month', 'Reg For Month') !!}<span style="color:red;">*</span> :
