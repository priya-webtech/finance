...
<div class="form-group col-sm-1" style="margin-top: 37px;">
    <input type="checkbox" id="gst" class="gstCheck" name="gst" value="1" @if(isset($modeOfPayment)) @if($modeOfPayment->gst == 1) checked @endif @endif>
     {!! Form::label('gst', 'GST') !!}
</div>