...
Route::group(['prefix' => 'admin','middleware' => ['auth']], function () {
    ...
    Route::get('/due-fees-view/{id}/{type}', [App\Http\Controllers\Admin\DueFeesController::class, 'view'])->name('due-fees-view');
    ...
    Route::get('/history',[App\Http\Controllers\Admin\DashBoardController::class, 'history'])->name('history')->middleware('can:history_view');
